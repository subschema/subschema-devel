...
exports.templates = exports.ModalTemplate = undefined;

var _ModalTemplate2 = __webpack_require__(55);

var _ModalTemplate3 = _interopRequireDefault(_ModalTemplate2);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ModalTemplate = exports.ModalTemplate = _ModalTemplate3.default;

var templates = exports.templates = { ModalTemplate: ModalTemplate };

exports.default = { templates: templates };
...
var _subschemaPropTypes = __webpack_require__(103);

var _subschemaPropTypes2 = _interopRequireDefault(_subschemaPropTypes);

var _RenderContent = __webpack_require__(113);
...
var ModalTemplate = function (_Component) {
    (0, _inherits3.default)(ModalTemplate, _Component);
    ...
    function ModalTemplate() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ModalTemplate.__proto__ || (0, _getPrototypeOf2.default)(ModalTemplate)).call.apply(_ref, [this].concat(args))), _this), _this.handleBtnClose = function (e) {
            e && e.preventDefault();
            _this.props.dismiss();
        }, _this.handleButtonClick = function (e, action, btn) {
            e && e.preventDefault();
            if (!_this.props.buttons) {
                return;
            }
            var onButtonClick = _this.props.buttons.onButtonClick;

            switch (action) {
                case 'cancel':
                case 'close':
                    _this.handleBtnClose(e);
                    return false;
                //handle submits and such
                default:
                    {
                        var errors = _this.props.validate && _this.props.validate();
                        if (errors) {
    ...
    (0, _createClass3.default)(ModalTemplate, [{
        ...
        value: function renderFooter(buttons) {
            ...
            var _buttons$template = buttons.template,
                template = _buttons$template === undefined ? this.props.buttonsTemplate : _buttons$template,
                rest = (0, _objectWithoutProperties3.default)(buttons, ['template']);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(Template, (0, _extends3.default)({}, trest, rest, {
        ...
        value: function render() {
            var _props = this.props,
                ...
                backdropClass = _props.backdropClass,
                dialogClass = _props.dialogClass,
                namespaceClass = _props.namespaceClass,
                overlayClass = _props.overlayClass,
                children = _props.children,
                rest = (0, _objectWithoutProperties3.default)(_props, ['title', 'legend', 'buttons', 'path', 'value', 'bodyClass', 'headerClass', 'closeClass', 'contentClass', 'backdropClass', 'dialogClass', 'namespaceClass', 'overlayClass', 'children']);


            return _react2.default.createElement(
                'div',
                { className: namespaceClass + ' ' + overlayClass,
                    style: { display: 'block' } },
                _react2.default.createElement('div', { className: backdropClass }),
                _react2.default.createElement(
                    'div',
                    { className: dialogClass, role: 'document',
                        style: { zIndex: 2000 } },
                    _react2.default.createElement(
                        'div',
...
ModalTemplate.propTypes = {
    stash: _subschemaPropTypes2.default.stash,
    unstashOnUnmount: _subschemaPropTypes2.default.unstash,
    clearStash: _subschemaPropTypes2.default.clearStash,
    validate: _subschemaPropTypes2.default.validateFields,
    style: _subschemaPropTypes2.default.style,
    title: _subschemaPropTypes2.default.content,
    ...
    dismiss: _subschemaPropTypes2.default.valueEvent,
    buttonsTemplate: _subschemaPropTypes2.default.template,
    legend: _subschemaPropTypes2.default.content,
...
ModalTemplate.defaultProps = {
    ...
    dismiss: function dismiss() {
        (0, _warning2.default)(false, 'no dismiss path given to modal');
    }
};
...
var _customPropType = __webpack_require__(53);
...
exports.checkPropTypes = exports.PropTypes = exports.exact = exports.shape = exports.oneOfType = exports.oneOf = exports.objectOf = exports.node = exports.instanceOf = exports.element = exports.arrayOf = exports.any = exports.symbol = exports.string = exports.object = exports.number = exports.func = exports.bool = exports.array = undefined;

var _internalPropTypes = __webpack_require__(111);

var _PropTypes = _interopRequireWildcard(_internalPropTypes);
...
//exports
var array = exports.array = (0, _customPropType2.default)(_PropTypes['array'], 'array');
var bool = exports.bool = (0, _customPropType2.default)(_PropTypes['bool'], 'bool');
var func = exports.func = (0, _customPropType2.default)(_PropTypes['func'], 'func');
var number = exports.number = (0, _customPropType2.default)(_PropTypes['number'], 'number');
var object = exports.object = (0, _customPropType2.default)(_PropTypes['object'], 'object');
var string = exports.string = (0, _customPropType2.default)(_PropTypes['string'], 'string');
var symbol = exports.symbol = (0, _customPropType2.default)(_PropTypes['symbol'], 'symbol');
var any = exports.any = (0, _customPropType2.default)(_PropTypes['any'], 'any');
var arrayOf = exports.arrayOf = (0, _customPropType2.default)(_PropTypes['arrayOf'], 'arrayOf');
var element = exports.element = (0, _customPropType2.default)(_PropTypes['element'], 'element');
var instanceOf = exports.instanceOf = (0, _customPropType2.default)(_PropTypes['instanceOf'], 'instanceOf');
var node = exports.node = (0, _customPropType2.default)(_PropTypes['node'], 'node');
var objectOf = exports.objectOf = (0, _customPropType2.default)(_PropTypes['objectOf'], 'objectOf');
var oneOf = exports.oneOf = (0, _customPropType2.default)(_PropTypes['oneOf'], 'oneOf');
var oneOfType = exports.oneOfType = (0, _customPropType2.default)(_PropTypes['oneOfType'], 'oneOfType');
var shape = exports.shape = (0, _customPropType2.default)(_PropTypes['shape'], 'shape');
var exact = exports.exact = (0, _customPropType2.default)(_PropTypes['exact'], 'exact');
...
var checkPropTypes = exports.checkPropTypes = checkPropTypes;
