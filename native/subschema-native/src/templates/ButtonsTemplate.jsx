    ...
    makeButtons(buttons) {
        ...
        return buttons.map((b, i) => {
            ...
            if (btn.primary && this.props.primaryClass) {
                ...
                btn.buttonTextClass =
                    this.props.primaryTextClass || this.props.textClass;
            }
            if (i == 0) {
                btn.buttonClass =
                    addClass(btn.buttonClass, this.props.buttonFirstClass);
            }
            if (i + 1 === length) {
                btn.buttonClass =
                    addClass(btn.buttonClass, this.props.buttonLastClass);
            }
